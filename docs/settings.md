...
retry:
  ...
  fallbackChains:
    ...
    google-antigravity/*:
      - google/*
      - google-vertex/*
    # Deterministic full-chain example: openai-codex/* fans out through Gemini,
    # Sonnet, Muse Spark, GLM, Copilot Auto (literal `auto`, openai-completions),
    # and Cursor.
    openai-codex/*:
...
| `retry.maxRetries`                       | number  | `10`              | Max same-model retries per request. A model fallback starts its own same-model retry budget.                                                                                                                                                                                                                                                                                                                                                                                               |
